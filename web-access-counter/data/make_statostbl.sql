...
insert into statostbl (pattern, real_name) values ('Windows NT 6.2', 'Windows 8/ Server 2012');
insert into statostbl (pattern, real_name) values ('Macintosh', 'Mac OS X');
insert into statostbl (pattern, real_name) values ('iPhone OS', 'iPhone OS');
insert into statostbl (pattern, real_name) values ('Linux', 'Linux/ Android');
